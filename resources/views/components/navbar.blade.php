    ...
    <div class="fixed top-0 left-0 right-0 h-20 bg-slate-800 border-b-2 border-solid border-slate-500 ">
        <div class="w-full h-full box-border flex justify-center items-center lg:px-12 p-6">
            <div class="w-full h-full flex justify-between items-center lg:gap-8 gap-2 ">
                ...
                <form action="/search" class="w-full h-full hidden md:flex justify-between items-center gap-4">
                    <input class="input-style w-full bg-none" name="search" type="text" placeholder="Search...">
                </form>
                <div class="h-full hidden md:flex justify-center items-center lg:gap-4 gap-2">
                    <div class="h-full flex justify-center items-center  gap-2">
                        ...
                        @endauth
                        @guest
                            <button class="nav-button " onclick="Livewire.emit('openModal', 'login')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="#ffffff" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" fill="none"
                                        d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                    ...
                    @auth
                        <div class="w-36 flex justify-start items-center gap-2 nav-button ring-1 ring-gray-300 cursor-default"
                            href="/profile">
                        ...
                        <form method="POST" action="/logout">
                            @csrf
                            <button type="submit"
                                class=" cursor-pointer rounded-lg hover:bg-slate-500 p-2 box-border align-middle text-white font-semibold">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
